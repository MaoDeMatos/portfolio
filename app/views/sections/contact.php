...
<section id="section-contact" class="color-theme-2 flex column">
  ...
  <div class="content flex column">
    ...
    <p>
      <a href="mailto:mao.dematos@gmail.com" class="highlighted">mao.dematos@gmail.com</a>
    </p>
    ...
    <ul class="flex flex-wrap">
      ...
      <li>
        <a href="https://gitlab.com/MaoDeMatos"><img id="gitlab_img" src="<?= $icons["gitlab"] ?>" title="GitLab" alt="GitLab" /></a>
      </li>
    </ul>
